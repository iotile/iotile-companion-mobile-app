...
export class TempController extends DeviceBaseController {
    private variables: { [key: string]: Variable };

    constructor($stateParams, $injector, $scope) {
        super("TempController", $stateParams.deviceId, $injector, $scope);
...
angular.module("main").controller("tempCtrl", TempController as any);
